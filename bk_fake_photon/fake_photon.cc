...
{ 
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++)
	...
	{ survived_events+=wt;
	  ...
	  faking_photon->Fill("NJets_{=0}^{2-4}",0);
	  faking_photon->Fill("NJets_{#geq 1}^{2-4}",0);
	  faking_photon->Fill("NJets_{=0}^{5-6}",0);
	  faking_photon->Fill("NJets_{#geq 1}^{5-6}",0);
	  faking_photon->Fill("NJets_{=0}^{#geq 7}",0);
	  faking_photon->Fill("NJets_{#geq 1}^{#geq 7}",0);
	  int njets = goodjets.size();

	  faking_photon_2->Fill("NJets_{0}^{=2} & 100<MET<150",0);
	  faking_photon_2->Fill("NJets_{0}^{=2} & MET#geq 150",0);
	  faking_photon_2->Fill("NJets_{0}^{=3} & 100<MET<150",0);
	  faking_photon_2->Fill("NJets_{0}^{=3} & MET#geq 150",0);
	  faking_photon_2->Fill("NJets_{0}^{=4} & 100<MET<150",0);
	  faking_photon_2->Fill("NJets_{0}^{=4} & MET#geq 150",0);
	  faking_photon_2->Fill("NJets_{0}^{5-6} & 100<MET<150",0);
	  faking_photon_2->Fill("NJets_{0}^{5-6} & MET#geq 150",0);
	  faking_photon_2->Fill("NJets_{0}^{#geq7} & 100<MET<150",0);
	  faking_photon_2->Fill("NJets_{0}^{#geq7} & MET#geq 150",0);
	  faking_photon_2->Fill("NJets_{#geq 1}^{2-4} & 100<MET<150",0);
	  faking_photon_2->Fill("NJets_{#geq 1}^{2-4} & MET#geq 150",0);
	  faking_photon_2->Fill("NJets_{#geq 1}^{5-6} & 100<MET<150",0);
	  faking_photon_2->Fill("NJets_{#geq 1}^{5-6} & MET#geq 150",0);
	  faking_photon_2->Fill("NJets_{#geq 1}^{#geq 7} & 100<MET<150",0);
	  faking_photon_2->Fill("NJets_{#geq 1}^{#geq 7} & MET#geq 150",0);
